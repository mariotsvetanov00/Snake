...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics graphics) {
        ...
        if (running) {
            ...
            graphics.drawString("Score: "+appleEaten,(SCREEN_WIDTH - metrics.stringWidth("Score: "+appleEaten))/2, graphics.getFont().getSize());
        }else {
            gameOver(graphics);
        }
    }
    ...
    public void gameOver(Graphics graphics) {
        ...
        graphics.drawString("Score: "+appleEaten,(SCREEN_WIDTH - metrics1.stringWidth("Score: "+appleEaten))/2, graphics.getFont().getSize());
        //Game Over text
        graphics.setColor(Color.red);
